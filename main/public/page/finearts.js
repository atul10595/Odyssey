...
"Judges decision would be considered final"
    ...
    $rc.click(function () {
        ...
        case 'biChromaticPainting':
            ...
            break;
        case 'imaginacia':
            imagePath = "../images/nonComress/classicPaint.jpg";
